...
Simply import `pear-downloader.min.js` to HTML via `<script>` tag. Refer to [code example](#使用方法) or consult [`/examples/downloader-test.html`](/examples/downloader-test.html) or [get-started](docs/get-started.md) for usages.<br/>
